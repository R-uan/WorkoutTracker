...
{
	public async Task<Exercise?> FindByGuid(Guid guid) => await _db.Exercise.FindAsync(guid);

	public async Task<Exercise> SaveNew(Exercise exercise)
	{
	...
	public async Task<bool> Update(Exercise target, ExerciseUpdateModel update)
	{
	...
	public async Task<bool> Delete(Exercise exercise)
	{
